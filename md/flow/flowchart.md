...
地图编辑器/JSON 数据
  ...
  -> v4.6 朝廷项目首片把征饷、赈济、招抚、农政、修城、团练、火器、粮台等主议/备议落到 Command.enactCourtProject 和 EconomyRules
...
flowchart TD
    ...
    COURTPROJ["朝廷四线项目<br/>CourtProjectDomain + CourtProjectKind / Command.enactCourtProject<br/>政策、经济、科技、军事分组；征饷、赈济、招抚、农政、修城、团练、火器、粮台"]:::command
