...
地图编辑器/JSON 数据
  ...
  -> v4.7 明末胜负链首片让清破关入京、大顺据中原秦陕、大西据湖广粮区、明廷守住京师关口等条件进入 BattleObjectiveSummary / VictoryRules，并在“目标”面板显示进度
...
flowchart TD
    ...
    OBJINFO["战役目标<br/>BattleObjectiveSummary + BattleObjectivePanelView<br/>四条胜负线、城关控制方和终局要冲分只读展示"]:::ui
