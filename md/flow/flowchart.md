...
地图编辑器/JSON 数据
  ...
  -> v4.6 UI 首片用 MingDesignTokens、独立 CourtPanelView、朝议争点、朝廷五线态势、朝报令条、军令牌、将印军令、将领名帖、军机复盘牌/军机五线、塘报战记/急务战役分类、部队军情牌/军令战备、州府牌归属旗号、府库牌收支急报、天下急势、舆图天下急势、天下战和张力条、阵营名义卡、中文军牌、势力旗号、城/关/粮 badge、粮道虚线/开关、军令计划线、舆图图例、兵种/粮草/堆叠图例和四线交叉项目分组 polish 主界面、地图部队和朝廷/将领/军令/AI 面板
...
flowchart TD
    ...
    UNITINFO["部队军情牌<br/>UnitInspectorView<br/>兵力、粮草、军令战备、攻守行程察、兵种编成和驻防归属只读展示"]:::ui
    REGIONINFO["州府牌<br/>RegionInspectorView<br/>城关粮坊、治理、钱粮城防、控制方旗号、原属章和当前格只读展示"]:::ui
    UI["地图和面板显示<br/>SpriteKit / SwiftUI Overlay<br/>v4.6 明末舆图、舆图天下急势、朝报令条、军令牌、将印军令、将领名帖、军机复盘牌、军机五线态势、势力军略、塘报战记/急务战役分类、天下急势/战和张力、朝议争点、朝廷五线态势、部队军情牌/军令战备、州府牌、府库牌、中文图层名、城/关/粮/兵种军牌/粮草堆叠/势力旗/军令计划图例、粮道虚线/开关、中文军牌、朝廷四线兼线项目、AI 面板 polish"]:::ui
