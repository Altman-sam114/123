...
地图编辑器/JSON 数据
  ...
  -> v4.6 UI 首片用 MingDesignTokens、MingMapLabelFormat、独立 CourtPanelView、朝议总纲、朝议批票、朝议争点、朝廷五线态势、朝报令条、军令牌/舆图军令提示、命令交互回执中文化、军机/战区诊断中文化、默认中文塘报、将印军令、将领名帖、军机复盘牌/军机五线/军机底稿/命令短令、最高意志朱批中文化、塘报战记/急务战役分类、部队军情牌/军令战备/军械火力/驻防归属可读化、舆图军牌浮签、州府牌归属旗号/方面防区可读化、府库牌收支急报/军饷民心、天下急势/朝议重心可读化、舆图天下急势、天下战和张力条、阵营名义卡、中文军牌、势力旗号、地图军牌战备小签、城/关/粮 badge、粮道虚线/开关、军令计划线、舆图图例、兵种/粮草/堆叠图例和四线交叉项目分组 polish 主界面、地图部队和朝廷/将领/军令/AI 面板
...
flowchart TD
    ...
    UI["地图和面板显示<br/>SpriteKit / SwiftUI Overlay<br/>v4.6 明末舆图、舆图天下急势、朝报令条、军令牌/舆图军令提示/命令回执中文化、军机/战区诊断中文化、默认中文塘报、将印军令、将领名帖、军机复盘牌、军机五线态势、势力军略、军机底稿、命令短令、最高意志朱批中文化、塘报战记/急务战役分类、天下急势/战和张力、朝议重心可读化、朝议批票、朝议争点、朝廷五线态势、部队军情牌/军令战备/军械火力/驻防归属可读化、舆图军牌浮签、州府牌/方面防区可读化、府库牌/军饷民心、中文图层名、城/关/粮/兵种军牌/粮草堆叠/势力旗/战备小签/军令计划图例、粮道虚线/开关、中文军牌、朝廷四线兼线项目、AI 面板 polish"]:::ui
...
flowchart TD
    ...
    LOG["塘报战记<br/>EventLogView<br/>最近 60 条 LogDisplayEntry + 急务/战役/战事/粮草/州府/天下计数"]:::ui
    AIUI["军机复盘牌<br/>AgentPanelView<br/>最高意志 + 决策摘要 + 军机五线态势 + 势力军略 + 战区指令 + 命令回执 + 军机底稿"]:::ui
