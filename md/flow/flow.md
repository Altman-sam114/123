...
MapEditor / JSON 数据
  ...
  -> BoardRenderState.showsSupplyRoutes / PlayerCommandState 军令计划线 / MapDisplayLayer 舆图图例 / UnitTooltipView 舆图军牌浮签、军位与要冲牵引 / UI overlay / 塘报战记 / WarDirectiveRecord
```
