...
MapEditor / JSON 数据
  ...
  -> BattleObjectivePanelView 天下棋眼 / 要冲缺口 / 目标 chip 只读显示控制方旗号并定位 selectedHex / selectedRegionId / focusedObjectiveId
