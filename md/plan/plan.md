...
| v4.7 | 明末胜负链、历史事件、教程、战役内容和可玩性 | 以中华世界局势驱动 10-20 回合目标链：松锦余波、山海关屏障、畿辅保卫、河南/陕西流民军扩张、催饷与饥荒、开封围城、湖广粮道；补齐明末胜负判断、事件 schema、教程和 AI 摘要，让政策、经济、科技、军事四线都能影响可玩目标 | 内容记录、事件 schema、胜负规则记录 |
