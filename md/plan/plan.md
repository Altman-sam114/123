...
| v4.7 | 明末胜负链、历史事件、教程、战役内容和可玩性 | 胜负链首片已落地：`Objective.points` 保留 JSON 分值，`VictoryRules` 对 `chongzhen_1642` 剧本支持清破山海关/北京、大顺控开封/洛阳/西安、大西控荆州/武昌、明廷最终回合守北京/山海关/武昌，以及最终 objective points 归属；后续继续以中华世界局势驱动 10-20 回合目标链、历史事件 schema、教程和 AI 摘要，让政策、经济、科技、军事四线都能影响可玩目标 | `v4.7_ming_victory_record.md`、内容记录、事件 schema、胜负规则记录 |
