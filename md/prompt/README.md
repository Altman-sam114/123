...
- v4.6 明末 UI polish 首片记录：`md/prompt/v4.0-明末迁移/v4.6_ming_ui_polish_record.md`；当前已落地明末设计 token、独立朝廷面板、军令/将领/战报/AI 中文 polish、单位中文军牌和明末舆图空态，真实美术资产、截图验收和完整响应式交互仍后置。
