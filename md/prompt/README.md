...
- v4.6 明末 UI polish 与朝廷项目记录：`md/prompt/v4.0-明末迁移/v4.6_ming_ui_polish_record.md`；当前已落地明末设计 token、独立朝廷面板、军令/将领/战报/AI 中文 polish、单位中文军牌、明末舆图空态，以及征饷、赈济、修城、团练、火器、粮台六类 `Command.enactCourtProject` 轻量执行入口；真实美术资产、截图验收、完整响应式交互、多回合政策和科技树仍后置。
